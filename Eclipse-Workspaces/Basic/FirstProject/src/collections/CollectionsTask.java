...
public class CollectionsTask {
	...
	public static void main(String[] args) {
		...
		VirtualEmployee virtual=new VirtualEmployee();
	...
	public static void addDetails(Employee employee,
			...
			ContractEmployee contract,VirtualEmployee virtual){
		employee.empid=10;
		List<Integer> list=new ArrayList();
		list.add(employee.empid);
		
		List<Employee> listPermanent=new ArrayList();
		listPermanent.add(permanent);
		
		Set <VirtualEmployee> set =new HashSet(); 
		set.add(virtual);
		
		System.out.println(list);
		System.out.println(listPermanent);
